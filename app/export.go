...
func (app *OinApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *OinApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
